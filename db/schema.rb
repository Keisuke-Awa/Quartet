...
ActiveRecord::Schema.define(version: 2021_03_13_010704) do
  ...
  create_table "message_rooms", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["discarded_at"], name: "index_message_rooms_on_discarded_at"
  end
  ...
  create_table "new_arrivals", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "user_id", null: false
